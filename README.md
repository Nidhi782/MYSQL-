...
This file documents the SQL statements in `EXP.sql`, describing the schema, sample data, and query sets (EXP1–EXP5/6).
...
- **Q14. Display length of the string 'NIDHI KUMARI'**

  ```sql
  SELECT LENGTH('NIDHI KUMARI');
  ```
